...
class DocumentRepositoryImpl @Inject constructor(
    ...
    override suspend fun importDocument(document: Document): Long = dao.insertDocuments(document.toEntity())

    override suspend fun deleteDocument(document: Document) = dao.deleteDocuments(document.toEntity())
